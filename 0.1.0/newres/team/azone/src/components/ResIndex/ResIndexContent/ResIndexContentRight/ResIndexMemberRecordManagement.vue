<template>
  <div class="memberlist clearfix">
    <span class="bread">
      ...
      <router-link to="/ResIndexMemberRecordManagement"><cite>账户管理</cite></router-link>
    </span>
    <div class="Other_Management">
      <div class="search_style">
        <ul class="search_content clearfix">
          <li>
            <label class="l_f">会员名称</label>
            <input type="text" class="text_add" placeholder="输入会员名称、电话、邮箱">
          </li>
          <li style="width:90px;">
      ...
      <div class="border clearfix">
        <span class="l_f">
          <a href="javascript:;" class="btn btn-danger">
              <img class="imgs" src="../../../../assets/img/res9.png">
              &nbsp;批量删除
          </a>
        </span>
      ...
      <div class="list_style">
        <div class="dataTables_wrapper no-footer">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="dataTables_filter"><label>搜索：<input type="search"></label></div>
            </div>
          </div>
          <table class="table">
            <thead>
    ...
    <div class="layui-layer-page">
      <div class="layui-layer-title">积分获取记录</div>
      <span class="layui-layer-setwin">
            <a href="javascript:;" class="layui-layer-close1 jiclose">
                <img src="../../../../assets/img/res8.png">
            </a>
        </span>
        ...
        <div class="layui-layer-wrap">
          <div class="dataTables_wrapper">
            ...
            <table class="table">
              <thead>
              <tr>
                <th style="width:91px;">用户</th>
                <th style="width:191px;">产品名称</th>
                <th style="width:91px; color: rgb(112, 112, 112);">价格(元)</th>
                <th style="width:146px; color: rgb(112, 112, 112);">积分</th>
                <th style="width:153px; color: rgb(112, 112, 112);">获得时间</th>
              </tr>
              </thead>
              <tbody>
              <tr class="odd">
                <td>花海天天</td>
                <td><a href="javascript:;">荣耀7i 海岛蓝 移动4G手机 双卡双待 </a></td>
                <td>2565</td>
                <td>1234</td>
...
<script>
  import $ from 'jquery'
    export default {
      name: "ResIndexMemberRecordManagement",
      directives:{
        drag(el,bindings){
