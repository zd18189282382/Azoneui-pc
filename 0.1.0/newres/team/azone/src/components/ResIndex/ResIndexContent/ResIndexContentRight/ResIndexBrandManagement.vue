<template>
<div class="brandmanagement clearfix">
   <span class="bread">
      <router-link to="/ResIndexPage"><cite>首页</cite></router-link>  /
      <a href="javascript:;"><cite>支付管理</cite></a>  /
      <router-link to="/ResIndexBrandManagement"><cite>账户管理</cite></router-link>
    </span>
  <div class="brand_style">
      <div class="search_style">
        <ul class="search_content clearfix">
          <li>
            ...
            <input type="text" class="text_add" placeholder="输入品牌名称">
          </li>
          <li><el-date-picker v-model="value1" size="small" type="date" placeholder="选择日期"></el-date-picker></li>
          <li>
            <select>
      ...
      <div class="border clearfix">
        <span class="l_f">
            <a href="javascript:;" class="btn btn-warning Order_form" title="添加品牌">
                <img src="../../../../assets/img/res_tianjia.png">
                添加品牌
            </a>
            ...
            <a href="javascript:;" class="btn btn-info">国内品牌</a>
            <a href="javascript:;" class="btn btn-success">国外品牌</a>
        </span>
        <span class="r_f">
            共：<b>234</b>个品牌
        </span>
      ...
      <div class="brand_list clearfix">
        ...
        <div class="chart_style">
          <div class="side_title">
            <a href="javascript:;" class="close_btn" title="隐藏">
              <span></span>
            </a>
          </div>
          <div class="main">
            <div id="histogram" style="width: 400px;height: 300px;"></div>
          </div>
        </div>
        <!-- 品牌列表 -->
            ...
            <table class="table">
              ...
              <tbody>
                <tr class="odd">
                  ...
                  <td>45631</td>
                  <td><input type="text" value="1" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_olay.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="玉兰油OLAY">玉兰油OLAY</a>
                  </td>
                  <td>法国</td>
                  <td>玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                  <td>2014-6-11 11:11:42</td>
                  <td class="td">
                    <span class="label label-success">已启用</span>
                    <span class="label label-successa">已停用</span>
                  </td>
                  <td class="tds">
                    <a href="javascript:;" title="停用" class="btn btn-xs btn-success btn-successs">
                      <img src="../../../../assets/img/res2.png">
                    </a>
                    <a href="javascript:;" title="停用" class="btn btn-xs btn-successa">
                      <img src="../../../../assets/img/res2.png">
                    </a>
                    <a href="javascript:;" title="编辑" class="btn btn-xs btn-info">
                      <img src="../../../../assets/img/res10.png">
                    </a>
                    <a href="javascript:;" title="删除" class="btn btn-xs btn-warnings btn-warning">
                      <img src="../../../../assets/img/res9.png">
                    </a>
                  </td>
                </tr>
                <tr class="even">
                  ...
                  <td>2045</td>
                  <td><input type="text" value="2" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_aupres.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="玉兰油OLAY">玉兰油OLAY</a>
                  </td>
                ...
                <tr class="odd">
                  ...
                  <td><input type="text" value="2" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_jiefang.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="御泥坊">御泥坊</a>
                  </td>
                  <td>法国</td>
                  <td>玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                  <td>2014-6-11 11:11:42</td>
                  ...
                  <td class="tds">
                    <a href="javascript:;" title="停用" class="btn btn-xs btn-success btn-success">
                      <img src="../../../../assets/img/res2.png">
                    </a>
                    <a href="javascript:;" title="停用" class="btn btn-xs btn-successa">
                      <img src="../../../../assets/img/res2.png">
                ...
                <tr class="even">
                  ...
                  <td><input type="text" value="2" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_vichy.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="薇姿">薇姿</a>
                  </td>
                  <td>法国</td>
                  <td>玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                  <td>2014-6-11 11:11:42</td>
                ...
                <tr class="odd">
                  ...
                  <td><input type="text" value="2" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_cetaphil.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="丝塔芙">丝塔芙</a>
                  </td>
                  <td>法国</td>
                  <td>玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                  <td>2014-6-11 11:11:42</td>
                ...
                <tr class="even">
                  ...
                  <td><input type="text" value="2" class="input-text"></td>
                  <td>
                    <img src="../../../../assets/img/res_bedook.jpg">
                  </td>
                  <td>
                    <a href="javascript:;" class="text-primary brond_name" title="比克度">比克度</a>
                  </td>
                  <td>法国</td>
                  <td>玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                  <td>2014-6-11 11:11:42</td>
  ...
  <!-- 确定要停用吗 -->
  <div class="layui-layer-dialogp layui-layer-dialogpfg drag" v-drag>
    <div class="layui-layer-titlep">信息</div>
    <span class="layui-layer-setwindp">
                <a href="javascript:;" class="layui-layer-closep tingclose"><img src="../../../../assets/img/res8.png" alt=""></a>
            </span>
    <div class="layui-layer-paddingp">
      确定要停用吗！
    </div>
    <div class="layui-layer-btnp">
      <a href="javascript:;" class="layui-layer-btn6 tingken">确定</a>
      <a href="javascript:;" class="layui-layer-btn7 tingqu">取消</a>
    </div>
  </div>
  <!-- 已停用 -->
  <div class="hen">
    <a href="#" class="hens">
      <img src="../../../../assets/img/res_hei.png" alt="">
      <span>停用!</span>
    </a>
  </div>
  <!-- 确定要启用吗 -->
  <div class="layui-layer-dialogp layui-layer-dialogpgh drag" v-drag>
    <div class="layui-layer-titlep">信息</div>
    <span class="layui-layer-setwindp">
            <a href="javascript:;" class="layui-layer-closep qiclose"><img src="../../../../assets/img/res8.png" alt=""></a>
        </span>
    <div class="layui-layer-paddingp">
      确定要启用吗！
    </div>
    <div class="layui-layer-btnp">
      <a href="javascript:;" class="layui-layer-btn6 qiken">确定</a>
      <a href="javascript:;" class="layui-layer-btn7 qiqu">取消</a>
    </div>
  </div>
  <!-- 已启用 -->
  <div class="happy">
  ...
  require('echarts/lib/component/toolbox');
    export default {
        ...
        mounted(){
          ...
          //停用
          let length = $(".btn-successs").length;
          let count = 0;
          let index = "";
          $(".btn-successs").each(function () {
            $(this).attr({"index":count});
            count++;
          });
          $(".btn-successa").each(function () {
            $(this).attr({"index":count});
            count++;
          });
          ...
          $('.btn-successs').click(function(){
            ...
            $('.layui-layer-dialogpfg').show();
            $('.layui-layer-shade').show();
            $('.tingclose').click(function(){
              $('.layui-layer-dialogpfg').hide();
              $('.layui-layer-shade').hide();
            });
            $('.tingqu').click(function(){
              $('.layui-layer-dialogpfg').hide();
              $('.layui-layer-shade').hide();
            });
            $('.tingken').click(function () {
              $('.layui-layer-dialogpfg').hide();
              $('.layui-layer-shade').hide();

              $(".btn-successs").eq(index).hide();
              $(".btn-successa").eq(index).show();
              $(".label-success").eq(index).hide();
              $(".label-successa").eq(index).show();
              $('.hen').show();
          ...
          //启用
          let lengthhh = $(".btn-successa").length;
          let counttt = 0;
          let indexss = "";
          $(".btn-successa").each(function () {
            $(this).attr({"indexss":counttt});
            counttt++;
          });
          $(".btn-successs").each(function () {
            $(this).attr({"indexss":counttt});
          ...
          $('.btn-successa').click(function(){
            indexss = $(this).attr("indexss");
            $('.layui-layer-dialogpgh').show();
            $('.layui-layer-shade').show();
            $('.qiclose').click(function(){
              $('.layui-layer-dialogpgh').hide();
              $('.layui-layer-shade').hide();
            });
            $('.qiqu').click(function(){
              $('.layui-layer-dialogpgh').hide();
            ...
            $('.qiken').click(function () {
              $('.layui-layer-dialogpgh').hide();
              $('.layui-layer-shade').hide();

              $(".btn-successa").eq(indexss).hide();
              $(".btn-successs").eq(indexss).show();
              $(".label-successa").eq(indexss).hide();
              $(".label-success").eq(indexss).show();
              $('.happy').show();
              setInterval(function () {
                $('.happy').hide();
              },2000);
          ...
          //删除用户
          let lengthh = $(".btn-warnings").length;
          let countt = 0;
          let indexs = "";
          $(".btn-warnings").each(function () {
...
.brandmanagement::-webkit-scrollbar{
  display: none;
}
.clearfix::before{
  display: table;
...
.show_btn span {
  background: url(../../../../assets/img/reshead_sprite.png) -46px -32px no-repeat;
  width: 25px;
  height: 100px;
  overflow: hidden;
  float: left;
